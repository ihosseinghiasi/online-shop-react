import mainImage from '../pictures/shopping01.jpg'
      ...
      <div className="main">
        ...
        <div className="custom-shape-divider-bottom-1694511368">
         ...
         <div className="expressCard">
            ...
            <p className="expressParagraph">چند مرحله ساده را بگذارید و محصول خود را دریافت کنید ، با اکسپرس کارت همه چیز آسان و در دسترس است.</p>
            <p className="expressParagraph">همچنین با اکپرس کارت میتوان در کمترین زمان ممکن و بهترین قیمت و بالاترین کیفیت بصورت لحظه ای خرید کنید و کد محصول را دریافت فرمایید.</p>
         </div>
        </div>
